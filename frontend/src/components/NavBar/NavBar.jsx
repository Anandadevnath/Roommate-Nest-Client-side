        ...
        <>
            <li>
                <NavLink 
                    to="/" 
                    className={({ isActive }) => 
                        `text-white home hover:text-blue-400 flex items-center gap-2 transition-all duration-300 px-4 py-2 rounded-lg hover:bg-blue-500/20 ${
            ...
            <li>
                <NavLink 
                    to="/aboutsection" 
                    className={({ isActive }) => 
                        `text-white about hover:text-blue-400 flex items-center gap-2 transition-all duration-300 px-4 py-2 rounded-lg hover:bg-blue-500/20 ${
                            isActive ? 'text-blue-400 bg-blue-500/20' : ''
                        }`
                    } 
                    onClick={closeMobileMenu}
                ...
                <>
                    <li>
                        <NavLink 
                            to="/createroom" 
                            className={({ isActive }) => 
                                `text-white room hover:text-blue-400 flex items-center gap-2 transition-all duration-300 px-4 py-2 rounded-lg hover:bg-blue-500/20 ${
                                    isActive ? 'text-blue-400 bg-blue-500/20' : ''
                                }`
                            } 
                            onClick={closeMobileMenu}
